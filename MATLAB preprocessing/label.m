...
%   Note:
%   ----
%   NaN values are ignored and considered as background. The elements of L
%   are integer values greater than or equal to 0. The pixels labeled 0 are
%   the background. The pixels labeled 1 make up one object, the pixels
...
%
%   -- Damien Garcia -- 2010/02, revised 2010/03
