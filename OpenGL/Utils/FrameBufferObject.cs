...
namespace WpfOpenTK.OpenGL.Utils
{
    internal class FrameBufferObject
    {
        ...
        public void Save(string fileName)
        {
            ...
            GL.ReadPixels(0, 0, mWidth, mHeight,
                          OpenTK.Graphics.OpenGL.PixelFormat.AbgrExt,
        ...
        private void SetupFrameBufferTexture()
        {
            ...
            if (GL.GetError() != ErrorCode.NoError)
            {
                ...
                logger.Error(GL.GetError().ToString() + "Frame Buffer Object - setup problem");
            ...
            {
                Logger logger = LogManager.GetCurrentClassLogger();
                logger.Error(GL.GetError().ToString() + "Frame Buffer Object - texture binding failed");
            ...
            GL.Ext.RenderbufferStorage(RenderbufferTarget.RenderbufferExt, (RenderbufferStorage)All.DepthComponent32, mWidth, mHeight);
